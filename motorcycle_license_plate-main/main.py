...
save_img = False   # Set to True if you want to save images (when using only image file)

# Adjust the threshold value of image classification when using image as input
# Lower the threshold value for more aggressive detection of helmet absence
head_classification_threshold = 3.0
    ...
    if ret == True:
        ...
        for rdr in rider_list:
            ...
            for hd in head_list:
                ...
                if inside_box([x1r, y1r, x2r, y2r], [x1h, y1h, x2h, y2h]):  # If this head is inside this rider bbox
                    try:
                    ...
                    if helmet_present[0] == True:  # If helmet is present
                    ...
                    elif helmet_present[0] == False:  # If helmet is absent
